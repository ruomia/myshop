...
<body>
		...
		<div id="item">
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap">
					<div class="sku-name">
						<h4>{{$goods->name}} <span id="sku-name">{{$data->name}}</span></h4>
					</div>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								@foreach($v as $v1)
								<dd><a href="javascript:;" name="{{$v1[0]}}" class="sku-list @if(in_array($v1[0], $data->valuer)) selected  @endif">{{$v1['1']}}<span title="点击取消选择">&nbsp;</span></a></dd>
								@endforeach
							</dl>
						...
						<form action="{{route('cart.store')}}" method="POST">
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" name="count" value="1" minnum="1" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										(库存量: <span id="stock">{{$data->stock}}</span>)
									...
									<li>
											...
											<button type="submit" class="sui-btn  btn-danger addshopcar">加入购物车</button>
		...
		<div class="toolbar-wrap J-wrap">
			<div class="toolbar">
				...
				<div class="toolbar-footer">
					<div class="toolbar-tab tbar-tab-top"> <a href="#"> <i class="tab-ico  "></i> <em class="footer-tab-text">顶部</em>
						</a> </div>
	...
	<script>
		$(function(){
			$(".sku-list").click(function(){
				// alert('haha');
				// var arr = $(this).parent().siblings('dd');
				// console.log(arr);
				// 让点击的被选中，同级下的取消选中
				$(this).addClass('selected').parent().siblings().children('a').removeClass('selected');
				var btn = document.getElementsByClassName('selected');
				// console.log(btn);
				var sku = '';
