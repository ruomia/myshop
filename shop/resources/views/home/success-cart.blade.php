            ...
            <div class="goods">
                <div class="left-good">
                    ...
                    <div class="right-info">
                        <p class="title">{{$data['goodsName']}} {{$data['name']}}</p>
                        <p class="attr">{{$data['value']}} 数量：{{$data['count']}}</p>
                    </div>
                </div>
                <div class="right-gocart">
                    <a href="{{route('item',['id'=>$data['sku_id']])}}" class="sui-btn btn-xlarge">查看商品详情</a>
                    <a href="{{route('cart.index')}}" class="sui-btn btn-xlarge btn-danger " target="_blank">去购物车结算 > </a>
                </div>
            </div>
            </div>
    </div>
