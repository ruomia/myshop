			...
			<div class="top">
				<div class="py-container">
					<div class="shortcut">
						...
						<ul class="fr">
							@if(session('id'))
							<li class="f-item"><a href="{{route('user.index',['id'=>session('id')])}}" target="_blank">个人中心</a></li>
				...
				<div class="py-container">
					<div class="yui3-g Logo">
						...
						<div class="yui3-u Center searchArea">
							<div class="search">
								<form action="{{route('search')}}" class="sui-form form-inline">
									<!--searchAutoComplete-->
									<div class="input-append">
										<input type="text" name="keyword" id="autocomplete" type="text" class="input-error input-xxlarge" />
					...
					@foreach($category as $v)
						<div class="item bo">
							...
							<div class="item-list clearfix">
								<div class="subitem">
									@foreach($v->allChildrenCategorys as $v1)
									<dl class="fore1">
										<dt><a href="">{{$v1->name}}</a></dt>
										<dd>
											@foreach($v1->allChildrenCategorys as $v2)
											<em><a href="{{route('search',['keyword'=>$v2->name])}}">{{$v2->name}}</a></em>
											@endforeach
										</dd>
									</dl>
									@endforeach
